      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {testimonials.map((testimonial, index) => (
            <article key={index} className="bg-gradient-to-br from-gray-50 to-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
        ...
        <div className="mt-8 sm:mt-12 text-center">
          <div className="inline-flex items-center gap-3 sm:gap-4 bg-primary-50 rounded-lg p-4 sm:p-6">
